...
public interface UsuarioRepository extends JpaRepository<Usuario, Long>{
    ...
    public List<Usuario> buscarNomeContido(String nomeUsuario);
    ...
    public Optional<Usuario> buscarNomeESenha(String nomeUsuario, String senha);
    ...
    public List<Usuario> buscarNomeAutorizacao(String nomeAutorizacao);

    public List<Usuario> findByIdGreaterThan(Long id);

    @Query("select u from Usuario u where u.id > ?1")
    public List<Usuario> buscarIdMaior(Long id);
}
